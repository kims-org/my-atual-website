...
export default function Home() {
	return (
		<>
			...
			<section class="bg-center bg-fixed bg-no-repeat bg-[url('https://www.novaurology.com/wp-content/uploads/2021/04/MYP_Summit-PR-3091-optimized.jpg')] bg-gray-700 bg-blend-multiply">
